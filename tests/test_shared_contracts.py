...
class SharedContractAlignmentTest(unittest.TestCase):
    ...
    def test_pydantic_models_validate_typescript_contract_examples(self):
        model_by_example = {
            ...
            "browserRunnerQueueMetrics": models.BrowserRunnerQueueMetrics,
            "browserRunnerQueueHealth": models.BrowserRunnerQueueHealth,
            "opsAlert": models.OpsAlert,
            "opsHeartbeatRequest": models.OpsHeartbeatRequest,
            ...
            "runtimeDiagnosis": models.RuntimeDiagnosis,
            "reportSection": models.ReportSection,
            "retentionCleanupRequest": models.RetentionCleanupRequest,
            "retentionCleanupResult": models.RetentionCleanupResult,
